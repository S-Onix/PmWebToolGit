...
<body>
	<article class="headerArticle">
		...
		<div class="header">
			...
			<input type="button" value="로그인" class="cancel" onclick="location='PmServlet?command=login_form'"> 
			<input type="button" value="회원가입" class="cancel" onclick="location='PmServlet?command=join_form'">
		</div>
		</article>